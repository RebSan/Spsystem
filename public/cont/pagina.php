...
class Pagina{
		      	...
		      	if(isset($_SESSION['user_pac'])) {
		      		...
		      		$header .= "<a href='../pag/index.php' class='brand-logo'>
	        					...
	        					<ul class='right hide-on-med-and-down'>
		          					<li><a href='#perf' class='modal-trigger'><i class='material-icons left'>perm_identity</i>$_SESSION[user_pac]</a></li>
		          					<li><a class='dropdown-button' href='#' data-activates='dropdown'><i class='material-icons left'>settings</i>Opciones</a></li>
		        				</ul>
	      		...
	      		else
	      		{
	      			$header .= "<a href='../../' class='brand-logo'>
	    						...
	    						<ul id='dropdown' class='dropdown-content'>\
		        					<li><a href='../pag/medicamentos.php'>medicamentos</a></li>
									<li><a href='../pag/consejos.php'>Consejos</a></li>
									<li><a href='../main/login.php'>Iniciar Sesion</a></li>
								</ul>
	...
	<div class='footer-copyrigh'>
		<div class='container' style='padding-top: 0px;'>Clínica Parroquial, Colonia Alta Vista</div>
	</div>
</footer>";
		print($footer);
	}
